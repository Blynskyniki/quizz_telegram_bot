...
/start <URL> - Начать викторину, загрузив вопросы из Google Sheets по указанному URL.
...
/help - Показать эту инструкцию.
  ...
  UNKNOWN_COMMAND: "Неизвестная команда. Используйте /help для получения списка команд.",
  QUIZ_RESULTS_GRAPH_ERROR: "Ошибка при создании графика результатов викторины.",
  VOTE_RESULTS_GRAPH_ERROR: "Ошибка при создании графика результатов голосования."
};
